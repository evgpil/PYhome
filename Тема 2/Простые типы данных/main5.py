...
speed_in_kb_in_sec = 4  # TODO перевести скорость скачивания из байт в килобайты, если 1 килобайт = 1024 байта
time_in_sec = 7200  # TODO перевести время в секунды

free_traffic = 500  # количество бесплатного трафика
file_size = 4*7200.0  # TODO размер файла
